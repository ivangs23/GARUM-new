...
function useElapsed(created_at) {
  const [elapsed, setElapsed] = reactExports.useState("");
  reactExports.useEffect(() => {
    const update = () => {
      const secs = Math.floor((Date.now() - new Date(created_at).getTime()) / 1e3);
...
function Column({ dest, orders, onDone }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { style: { display: "flex", flexDirection: "column", gap: "0.75rem" }, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { fontSize: "1.2rem" }, children: icon }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { style: { flex: 1, fontSize: "0.9rem", letterSpacing: "0.1em", fontWeight: 700 }, children: dest.toUpperCase() }),
...
function Orders() {
  ...
  const upsert = reactExports.useCallback((order) => {
    setOrders((prev) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", flexDirection: "column", height: "100%" }, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { fontWeight: 600, fontSize: "0.9rem" }, children: "Pedidos activos" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { fontSize: "0.8rem", color: "var(--muted)" }, children: total === 0 ? "Todo listo ✓" : `${total} mesa${total > 1 ? "s" : ""} pendiente${total > 1 ? "s" : ""}` })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: {
      flex: 1,
      overflow: "hidden",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(Column, { dest: "cocina", orders, onDone: markDone }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Column, { dest: "barra", orders, onDone: markDone })
    ] })
  ] });
}
function newPrinter(overrides = {}) {
  return {
...
function Settings({ onSaved: _onSaved }) {
  ...
  const addPrinter = (p) => setPrinters((ps) => [...ps, p]);
  const updatePrinter = (p) => setPrinters((ps) => ps.map((x) => x.id === p.id ? p : x));
  const deletePrinter = (id) => setPrinters((ps) => ps.filter((p) => p.id !== id));
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { padding: "2rem", maxWidth: 640, overflowY: "auto", height: "100%" }, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { style: { fontSize: "1.2rem", fontWeight: 700, marginBottom: "2rem" }, children: "Configuración" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      PrintersSection,
      {
        printers,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "button",
      {
        ...
        children: saving ? "Guardando..." : saved ? "✓ Guardado" : "Guardar"
      }
    )
  ] });
}
function PrintersSection({
  ...
  const [scanning, setScanning] = reactExports.useState("idle");
  const [scanMsg, setScanMsg] = reactExports.useState("");
  ...
  const handleScanNetwork = async () => {
    setScanning("network");
    setScanMsg("Escaneando subredes 192.168.0/1 y 10.0.0…");
    setDiscovered([]);
    try {
  ...
  const handleTest = async (printer) => {
    ...
    try {
      ...
      setTimeout(() => setTestStates((s) => ({ ...s, [printer.id]: "idle" })), 5e3);
    }
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { style: { marginBottom: "2rem" }, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { style: sectionTitle, children: "Impresoras" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", gap: "0.5rem", marginBottom: "0.75rem", flexWrap: "wrap" }, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { style: ghostBtn, disabled: scanning !== "idle", onClick: handleListWindows, children: scanning === "windows" ? "Buscando..." : "Listar impresoras Windows" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { style: ghostBtn, disabled: scanning !== "idle", onClick: handleScanNetwork, children: scanning === "network" ? "Escaneando red..." : "Buscar en red (9100)" })
    ] }),
    scanMsg && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: { color: "var(--muted)", fontSize: "0.8rem", marginBottom: "0.75rem" }, children: scanMsg }),
    discovered.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: { fontSize: "0.7rem", color: "var(--muted)", padding: "0.5rem 0.75rem 0.3rem", textTransform: "uppercase", letterSpacing: "0.06em" }, children: "Encontradas — pulsa + para añadir" }),
      discovered.map((d, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: {
        display: "flex",
        alignItems: "center",
        justifyContent: "space-between",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { fontSize: "0.85rem" }, children: d.type === "windows" ? `🖨 ${d.name}` : `🌐 ${d.host}:${d.port}` }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
    ...
    printers.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: { color: "var(--muted)", fontSize: "0.85rem", marginBottom: "1rem" }, children: "No hay impresoras configuradas todavía." }),
    printers.map((p) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      PrinterRow,
      {
        printer: p,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("button", { style: { ...ghostBtn, marginTop: "0.5rem" }, onClick: () => onAdd(newPrinter()), children: "+ Nueva impresora" })
  ] });
}
function PrinterRow({
  printer,
  ...
  const testColor = testState === "ok" ? "var(--green)" : testState === "error" ? "var(--red)" : testState === "testing" ? "var(--muted)" : "var(--text)";
  const testLabel = testState === "ok" ? "✓ OK" : testState === "error" ? "✗ Error" : testState === "testing" ? "Probando..." : "Probar";
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: {
    border: "1px solid var(--border)",
    borderRadius: 10,
    padding: "1rem",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", gap: "0.5rem", marginBottom: "0.75rem", alignItems: "center" }, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "input",
        {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "grid", gridTemplateColumns: "1fr 1fr", gap: "0.5rem", marginBottom: "0.5rem" }, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "Destino", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "select",
        {
          style: inputStyle,
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "cocina", children: "Cocina" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "barra", children: "Barra" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "all", children: "Todos" })
          ]
        }
      ) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "Tipo de conexión", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "select",
        {
          style: inputStyle,
          value: printer.adapter,
          onChange: (e) => set("adapter", e.target.value),
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "escpos-tcp", children: "Red / TCP (ESC/POS)" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "windows", children: "Controlador Windows" })
          ]
        }
      ) })
    ] }),
    printer.adapter === "escpos-tcp" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "grid", gridTemplateColumns: "1fr 120px", gap: "0.5rem" }, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "IP de la impresora", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        "input",
        {
          style: inputStyle,
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "Puerto", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        "input",
        {
          style: inputStyle,
          type: "number",
    ...
    printer.adapter === "windows" && /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "Nombre de impresora (Windows)", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      "input",
      {
        style: inputStyle,
...
function Field({ label, children }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { marginBottom: "0.75rem" }, children: [
...
function App() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", height: "100vh", overflow: "hidden" }, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("aside", { style: {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { padding: "0 1rem 1.5rem", borderBottom: "1px solid var(--border)" }, children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("nav", { style: { flex: 1, padding: "1rem 0" }, children: [["orders", "🍽 Comandas"], ["settings", "⚙️ Configuración"]].map(([p, label]) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          ...
          style: {
            ...
            textAlign: "left",
            background: page === p ? "rgba(123,79,150,0.15)" : "none",
            border: "none",
            borderLeft: page === p ? "3px solid var(--primary)" : "3px solid transparent",
