  ...
  return (
    <div className="login-container">
      <div className="login-card glass">
        <div className="login-header">
          <Image
            ...
            width={786}
            height={472}
            style={{ width: '150px', height: 'auto', display: 'block', margin: '0 auto 0.4rem' }}
            priority
          />
          <p>Panel de Staff</p>
        </div>
      ...
      <style jsx>{`
        ...
        .field-icon { position:absolute; left:1rem; color:var(--text-muted); }
        .field input { width:100%; padding:0.85rem 1rem 0.85rem 2.5rem; background:var(--surface); border:1px solid var(--border); border-radius:10px; color:var(--text); font-size:0.95rem; outline:none; transition:border-color 0.2s; box-sizing:border-box; }
        .field input:focus { border-color:var(--primary); }
        .error-msg { color:#f87171; font-size:0.85rem; text-align:center; margin:0; }
        :global(.gold-button) { margin-top:0.5rem; display:flex; align-items:center; justify-content:center; }
