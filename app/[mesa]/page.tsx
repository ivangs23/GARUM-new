  ...
  return (
    <div className="menu-container">
      ...
      <style jsx>{`
        ...
        .navbar { position:fixed; top:0; left:0; width:100%; z-index:100; background:var(--primary); box-shadow:var(--card-shadow); border:none; }
        ...
        .brand h1 { font-size:1.6rem; margin:0; letter-spacing:0.12em; color:#fff; font-family:var(--font-playfair); }
        .brand-sub { font-size:0.65rem; color:rgba(255,255,255,0.8); letter-spacing:0.2em; text-transform:uppercase; }
        .navbar-right { display:flex; align-items:center; gap:0.8rem; }
        .table-badge { font-size:0.65rem; background:#fff; color:var(--primary); padding:0.2rem 0.6rem; border-radius:4px; font-weight:800; letter-spacing:0.08em; }
        .icon-btn { background:none; border:none; color:#fff; cursor:pointer; display:flex; transition: transform 0.2s; }
        .icon-btn:hover { transform:scale(1.1); }
        .search-bar { display:flex; align-items:center; gap:0.5rem; padding:0.6rem 1.2rem 0.8rem; max-width:800px; margin:0 auto; background:var(--primary); }
        .search-bar input { flex:1; background:rgba(255,255,255,0.1); border:1px solid rgba(255,255,255,0.2); border-radius:10px; padding:0.6rem 1rem; color:#fff; font-size:0.95rem; outline:none; }
        .search-bar input::placeholder { color:rgba(255,255,255,0.6); }
        .search-bar input:focus { border-color:#fff; background:rgba(255,255,255,0.15); }
